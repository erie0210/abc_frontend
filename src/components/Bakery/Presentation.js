...
import { getBakeryData, getPublicRecipeData } from "../../../apis";

import AppLoading from "expo-app-loading";
import Bakery from "../../modules/BakeryListElem";
...
export default RecipesPresentation = ({ refreshFn, loading, recipes }) => {
  // console.log("RecipesPresentation", recipes);
  ...
  const handleLoading = async () => {
    ...
    const res = await getBakeryData(page + 1);
    setData(res);
